...
# $Header: /var/cvsroot/gentoo-x86/www-servers/nginx/nginx-0.7.38.ebuild,v 1.1 2009/02/26 15:17:34 voxus Exp $
...
IUSE="addition debug fastcgi flv imap pcre perl realip random-index ssl status sub webdav zlib"
