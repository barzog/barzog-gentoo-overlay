...
# $Header: /var/cvsroot/gentoo-x86/www-servers/nginx/nginx-0.7.30.ebuild,v 1.1 2008/12/25 15:11:19 voxus Exp $
...
IUSE="addition debug fastcgi flv imap pcre perl realip ssl status sub webdav zlib"
