...
IUSE="+asm bindist gmp kerberos rfc3779 sctp cpu_flags_x86_sse2 sslv2 +sslv3 static-libs test +tls-heartbeat vanilla zlib chacha20_poly1305"
...
src_prepare() {
	...
	if use chacha20_poly1305 ; then
		epatch "${FILESDIR}"/${PN}-1.0.2j-chacha20_poly1305_cf.patch
	fi
