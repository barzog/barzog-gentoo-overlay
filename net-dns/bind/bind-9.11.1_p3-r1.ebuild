...
json ldap libressl lmdb logging mysql nslint odbc postgres python rpz seccomp selinux ssl static-libs
...
src_prepare() {
	if use logging; then
		# enable dns answer logging
		epatch "${FILESDIR}"/${PN}-9.11.1-logging.patch
	fi
